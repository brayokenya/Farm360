...
from .views import SignUpView, ProfileView, EventListView, EventCreateView,EventDeleteView, EventUpdateView, IndexView, EventDetailView, LivestockCreateView, LivestockListView, LivestockDetailView

urlpatterns = [
    path('', IndexView.as_view(), name='index'),
    path('dashboard/', EventListView.as_view(), name='home'),
